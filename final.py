...
def table_image():
    if request.method =='POST':
        ...
        cropped_img = table_detect(img_file)
        final_output(cropped_img)
        # img_io = io.BytesIO()
        # cropped_img.save(img_io, 'PNG')
        # img_io.seek(0)
        return send_file('output_final.xlsx')
...
def final_output(image_PIL):
    ...
    for i in merge_indices:
        cell_address1 = index_to_excel_cell(i[0],len_columns)
        cell_address2 = index_to_excel_cell(i[1],len_columns)
